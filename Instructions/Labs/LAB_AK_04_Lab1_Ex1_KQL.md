...
**Query 1** will return all rows of SecurityAlert and all rows of SecurityEvent.
...
**Query 2** will return one row and column, which is the count of all rows of SecurityAlert and all rows of SecurityEvent.
...
**Query 3** will return all rows of SecurityAlert and one (last) row for SecurityEvent. The last row for SecurityEvent will have the summarized count of the total number of rows.
