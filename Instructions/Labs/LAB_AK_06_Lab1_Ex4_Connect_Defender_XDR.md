...
>**Note:** The *Microsoft Defender for Cloud* solution installs the *Microsoft Defender XDR* Data connector, Hunting queries, Workbooks and Analytics rules.
...
1. You shoud see a message that the connection was successful.
