...
1. If you aren't already at the **Microsoft Defender XDR** portal, start the **Microsoft Edge** browser, and navigate to **Microsoft Defender XDR** at `https://security.microsoft.com`, and login as Admin for your tenant.
...
1. Review the contents of the **IP address** page *Overview, Incidents & alerts and Observed in organizations* tabs. Some tabs may not contain information for the IP address.
